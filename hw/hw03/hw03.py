...
def count_coins(change):
    ...
    """
    "*** YOUR CODE HERE ***"
    def constraint_coins(change, largest_coins):
        if change == 0:
            return 1
        elif change < 0:
            return 0
            ...
            return 0
        without_coin = constraint_coins(change, get_smaller_coin(largest_coins))
        with_coin = constraint_coins(change - largest_coins, largest_coins)
        return with_coin + without_coin
    return constraint_coins(change, 25)
